                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr v-for="keranjang in keranjangUser" :key="keranjang.id">
                                            ...
                                            <td class="p-price first-row">Rp {{ formatPrice(keranjang.price) }}</td>
                                            <td @click="removeItem(keranjang.id)" class="delete-item"><a href="#"><i class="material-icons">
                                              close
                                              </i></a></td>
                        ...
                        <div class="col-lg-12">
                            <div class="proceed-checkout text-left">
                                <ul>
                                    ...
                                    <li class="subtotal mt-3">Subtotal <span>Rp {{ formatPrice(totalHarga) }}</span></li>
                                    <li class="subtotal mt-3">Pajak <span>10% {{ formatPrice(ditambahPajak)}} </span></li>
                                    <li class="subtotal mt-3">Total Biaya <span>Rp {{ formatPrice(totalBiaya)}} </span></li>
...
export default {
  ...
  methods: {
      ...
      removeItem(idx) {
          ...
          //cocokkan idx dengan id yang ada di storage
