...
export default {
  ...
  methods: {
      ...
      setDataPicture(data) {
          this.productDetails = data; // replace object productDetails dengan data dari API
          this.gambar_default = data.galleries[0].photo; // replace value gambar default dengan data dari API (galleries)          
      },
  ...
  mounted() {
        ...
        axios
            ...
            .then(response => (this.setDataPicture(response.data.meta.data)))
            // .then(response => (this.productDetails = response.data.meta.data))
                // this.products = console.log(response)
